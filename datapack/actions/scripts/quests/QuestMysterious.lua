...
doPlayerSendTextMessage(cid, 22, "Parabéns você desvendou com SUCESSO o Misterio dos Sabios, como recompensa voce ganhou um "..pokemon..", cuide dele e treine ele, faça por merecer.")
