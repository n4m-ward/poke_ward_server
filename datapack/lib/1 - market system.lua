...
MARKET_AVAIABLE_OPTIONS = {"All", "Pokemons", "Decoracoes", "Stones"} -- para adicionar mais categorias voce adiciona aqui (e na source)
...
function onOpenMarketWindow(playerId)
	...
	if not getTileInfo(getCreaturePosition(playerId)).protection then
		doPlayerSendTextMessage(playerId, 25, "Market permitido apenas em zona de proteção.")
		return true
	end
