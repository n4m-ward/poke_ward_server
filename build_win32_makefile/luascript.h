...
class LuaScriptInterface
{
	public:
		...
		{
			return ++m_scriptEnvIndex < 51;
		}
		static void releaseEnv()
		{
			if(m_scriptEnvIndex >= 0)
			{
				//ScriptEnviroment env = m_scriptEnv[m_scriptEnvIndex];
				//if (env) {
	...
	protected:
		...
		static int32_t luaDoPushThing(lua_State* L); // Thalles Vitor
		static int32_t luaDoMoveItem(lua_State* L); // Thalles Vitor
		static int32_t luaDoPlayerSetStatus(lua_State* L); // Thalles Vitor
		static int32_t luaDoPlayerGetStatus(lua_State* L); // Thalles Vitor
		...
		static int32_t convertIPAddress(lua_State* L);
		...
		static int32_t luaDoConvinceGuardian(lua_State* L); // Thalles Vitor
		...
		static int32_t luaDoMonsterSetTarget2(lua_State* L);
		...
		static int32_t luaDoPlayerAddMoney2(lua_State* L);
		...
		static int32_t luaDoPlayerSetLootRate(lua_State* L);
		...
		static int32_t luaGetCreatureGuardians(lua_State* L); // Thalles Vitor
		static int32_t luaDoDropPokemon(lua_State* L); // Thalles - PokeBar
		static int32_t luaDoUseItem(lua_State* L); // Thalles Vitor - Usar item
	...
	private:
		...
		static ScriptEnviroment m_scriptEnv[51];
