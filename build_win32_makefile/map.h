...
class Map
{
	public:
		...
		// Thalles Vitor - OTCV8
		static const int32_t maxClientV8ViewPortX = 14;
		static const int32_t maxClientV8ViewPortY = 10;

		static const int32_t maxViewportV8X = maxClientV8ViewPortX + 2; //min value: maxClientViewportX + 1
		static const int32_t maxViewportV8Y = maxClientV8ViewPortY + 2; //min value: maxClientViewportY + 1
		...
		*/
		...
		bool getPathMatching(const Creature* creature, const Position& targetPos, std::list<Direction>& dirList,
